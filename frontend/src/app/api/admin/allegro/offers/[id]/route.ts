// frontend\src\app\api\admin\allegro\offers\[id]\import\route.ts
    ...
    const productData: IProduct = {
      ...
      rpm: {
        value:
          ...
          "0",
        range: "",
        unit: "obr/min" as const,
      },
      startType: "bezpośredni - 230/400V", // Domyślna wartość
